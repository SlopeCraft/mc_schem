...
#ifndef MC_SCHEM_MC_SCHEM_OLD_H
#define MC_SCHEM_MC_SCHEM_OLD_H
#ifdef __cplusplus
...
MC_SCHEM_EXPORT bool MC_SCHEM_nbt_get_string(const MC_SCHEM_nbt_value *tag_string, MC_SCHEM_string_view *dest);
